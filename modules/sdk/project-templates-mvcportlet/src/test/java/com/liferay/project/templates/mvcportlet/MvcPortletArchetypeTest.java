...
package com.liferay.project.templates.mvcportlet;
 ...
 */
public class MvcPortletArchetypeTest {
	@Before
	...
	@Test
	public void testMvcPortletArchetype() throws Exception {
		String[] args = {
			"archetype:generate",
			"-B",
			"-DarchetypeArtifactId=com.liferay.project.templates.mvcportlet",
