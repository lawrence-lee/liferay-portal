...
package com.liferay.project.templates.servicebuilder;
 ...
 */
public class ServiceBuilderArchetypeTest {
	@Before
	...
	@Test
	public void testServiceBuilderArchetype() throws Exception {
		String[] args = {
			"archetype:generate",
			"-B",
			"-DarchetypeArtifactId=com.liferay.project.templates.servicebuilder",
			"-DarchetypeGroupId=com.liferay",
			"-DarchetypeVersion=1.0.0",
			"-DgroupId=com.test",
			"-DartifactId=bar",
			"-DpackageName=com.liferay.docs.guestbook"
		};
