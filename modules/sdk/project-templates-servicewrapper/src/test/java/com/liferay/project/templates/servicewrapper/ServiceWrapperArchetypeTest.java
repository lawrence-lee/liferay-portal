...
package com.liferay.project.templates.servicewrapper;
 ...
 */
public class ServiceWrapperArchetypeTest {
	@Before
	...
	public void testServiceWrapperArchetype() throws Exception {
		String[] args = {
			"archetype:generate",
			"-B",
			"-DarchetypeArtifactId=com.liferay.project.templates.servicewrapper",
