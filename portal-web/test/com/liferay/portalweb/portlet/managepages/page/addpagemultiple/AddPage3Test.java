	...
	public void testAddPage3() throws Exception {
		...
		while (label >= 1) {
			...
			case 3:
				...
				for (int second = 0;; second++) {
					...
					try {
						if (selenium.isVisible(
									"link=Manage3 Pages3 Test3 Page3")) {
							break;
						}
					}
					catch (Exception e) {
				...
				selenium.saveScreenShotAndSource();
				selenium.clickAt("link=Manage3 Pages3 Test3 Page3",
					RuntimeVariables.replace("Manage3 Pages3 Test3 Page3"));
				selenium.waitForPageToLoad("30000");
				selenium.saveScreenShotAndSource();
				assertTrue(selenium.isVisible("link=Manage1 Pages1 Test1 Page1"));
				assertTrue(selenium.isVisible("link=Manage2 Pages2 Test2 Page2"));
				assertEquals(RuntimeVariables.replace(
						"Manage3 Pages3 Test3 Page3"),
