 ...
 */
public class ConfigureUSPortletTest extends BaseTestCase {
	public void testConfigureUSPortlet() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("_86_displayActivityCounterName6")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.click("_86_displayActivityCounterName6");
		selenium.select("_86_displayActivityCounterName6",
			RuntimeVariables.replace("label=User's Cancelled Subscriptions"));
