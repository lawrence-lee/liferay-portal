 ...
 */
public class ViewParticipationLimitValueTest extends BaseTestCase {
	public void testViewParticipationLimitValue() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		selenium.click("//li[3]/div/div/div[2]/a[1]/span");
		selenium.select("VIEW_participationLimitValue",
			RuntimeVariables.replace("label=2"));
		selenium.click("//select[@id='VIEW_participationLimitValue']/option[3]");
		selenium.select("VIEW_participationLimitPeriod",
			RuntimeVariables.replace("label=times"));
		selenium.click(
			"//select[@id='VIEW_participationLimitPeriod']/option[2]");
