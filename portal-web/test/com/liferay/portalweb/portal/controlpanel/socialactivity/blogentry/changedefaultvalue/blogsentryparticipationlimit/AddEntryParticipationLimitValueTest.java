 ...
 */
public class AddEntryParticipationLimitValueTest extends BaseTestCase {
	public void testAddEntryParticipationLimitValue() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		selenium.clickAt("//li[1]/div/div/div[2]/a[1]/span",
			RuntimeVariables.replace("Limit"));
		selenium.select("ADD_ENTRY_participationLimitValue",
			RuntimeVariables.replace("label=2"));
		selenium.clickAt("//select[@id='ADD_ENTRY_participationLimitValue']/option[3]",
			RuntimeVariables.replace("ADD_ENTRY_participationLimitValue"));
		selenium.select("ADD_ENTRY_participationLimitPeriod",
