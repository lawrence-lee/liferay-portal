 ...
 */
public class SAU_ReadBlog1Test extends BaseTestCase {
	public void testSAU_ReadBlog1() throws Exception {
		...
		selenium.click(RuntimeVariables.replace("_33_TabsBack"));
		...
		assertEquals(RuntimeVariables.replace("Contribution Score: 3"),
