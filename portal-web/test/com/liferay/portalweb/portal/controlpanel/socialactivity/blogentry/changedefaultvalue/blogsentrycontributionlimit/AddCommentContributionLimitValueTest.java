 ...
 */
public class AddCommentContributionLimitValueTest extends BaseTestCase {
	public void testAddCommentContributionLimitValue()
		throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		selenium.click("//li[2]/div/div/div[2]/a[1]/span");
		selenium.select("ADD_COMMENT_contributionLimitValue",
			RuntimeVariables.replace("label=2"));
		selenium.clickAt("//select[@id='ADD_COMMENT_contributionLimitValue']/option[3]",
			RuntimeVariables.replace("ADD_COMMENT_contributionLimitValue"));
		selenium.select("ADD_COMMENT_contributionLimitPeriod",
			RuntimeVariables.replace("label=times"));
		selenium.click(
			"//select[@id='ADD_COMMENT_contributionLimitPeriod']/option[2]");
