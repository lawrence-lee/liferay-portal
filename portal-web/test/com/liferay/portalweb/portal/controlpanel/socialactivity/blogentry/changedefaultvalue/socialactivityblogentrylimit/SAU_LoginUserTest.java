 ...
 */
public class SAU_LoginUserTest extends BaseTestCase {
	public void testSAU_LoginUser() throws Exception {
		...
		selenium.type("//input[@id='_58_login']",
			RuntimeVariables.replace("SAU@liferay.com"));
