 ...
 */
public class SAU_Reply2BlogTest extends BaseTestCase {
	public void testSAU_Reply2Blog() throws Exception {
		...
		selenium.type("//textarea", RuntimeVariables.replace("User2"));
